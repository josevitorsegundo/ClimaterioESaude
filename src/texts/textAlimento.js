...
const TextAlimentos = () => {
      return (
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.textoSubtitulo}>Adotar alimentação uma saudável durante toda a 
          vida e manter esse hábito no climatério pode diminuir o risco de adquirir doenças do
           coração, diabetes, obesidade, osteoporose e demência (HARVIE; HOWELL; EVANS, 2015).
           </Text>
          
          <Text style={styles.textoTitulo}>Conheça e siga os dez passos para uma alimentação 
          saudável (BRASIL, 2014; GARCIA, 2019) </Text>
          
          <Text style={styles.textoSubtitulo}>Passo 1 - Faça dos alimentos in natura (naturais) a base da sua 
          alimentação: grãos, raízes, tubérculos, farinhas, legumes, verduras, frutas, castanhas, 
          leite, ovos e carnes, feijão, arroz, milho, batata, tomate, abóbora, laranja, banana, 
          frango e peixes; </Text>
          ...
          conservas de legumes, compotas de frutas, pães, queijos, por exemplo;</Text>
           ...
           <Text style={styles.textoSubtitulo}>Passo 6 - Compre seus alimentos em locais que 
           ofereçam variedade de alimentos naturais ou minimamente processados. Sempre que 
           possível, dê preferência aos alimentos orgânicos, ou seja, aqueles produzidos de 
           forma natural; </Text>
            <Text style={styles.textoSubtitulo}>Passo 7 - Desenvolva o hábito de cozinhar: 
            pratique e partilhe suas habilidades culinárias com outras pessoas; </Text>
            ...
            semana; </Text>
            <Text style={styles.textoSubtitulo}>Passo 9 - Quando estiver fora de casa, prefira 
            locais que sirvam refeições feitas na hora. Fast- food, lanches rápidos ou 
            sanduíches devem ser evitados; </Text>
