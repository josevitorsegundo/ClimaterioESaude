...
const TextSintomas = () => {
      return (
        ...
        <View style={styles.container}>
            ...
            ou nenhum sintoma. Eles ocorrem devido à queda nos níveis dos hormônios femininos nesse período 
            ...
            da insônia, não sendo necessário, na maioria das vezes, o uso de medicamentos 
            (MANESS, KHAN, 2015; SANTOS et al., 2017; SOGESP, 2019).</Text>
            ...
            ruídos altos e luzes brilhantes, exposição a frio ou calor em 
            excesso;</ Text>
            ...
            passiflora, valeriana, melissa e avenna sativa (aveia).</ Text>
            ...
            padrão de sono adequado (MANESS, KHAN, 2015; SOGESP, 2019).</ Text>
            ...
            infecções urinárias e de perda de urina sem controle (incontinência) 
            ...
            três a cinco anos (BRASIL, 2010; BRASIL, 2016; BRASIL, 2018).</ Text>
            ...
            frequentes e de longa duração (BRASIL, 2016).</ Text>
        </View>
        </ScrollView>
      );
  }
