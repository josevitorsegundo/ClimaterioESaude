...
const TextSono = () => {
      return (
        ...
        <View style={styles.container}>
          ...
          <Text style={styles.textoSubtitulo}>•	Durma em ambiente adequado, mantendo o quarto sem 
          luminosidade, com temperatura agradável e sem ruídos;</Text>
           <Text style={styles.textoSubtitulo}>• Evite consumir substâncias estimulantes (como cafeína, 
           nicotina e álcool) entre quatro a seis horas antes de deitar;</ Text>
